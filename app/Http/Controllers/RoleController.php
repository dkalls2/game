...
class RoleController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        $this->validateWith([
          ...
          if ($request->permissions) {
            $role->syncPermissions(explode(',', $request->permissions));
                //this has to do with relationships.
                //this syncs the permissions.  We pass in the permissions array with all of the permission names that we want synced to this role.
                //to do this, we need to grab the "permissions" hidden input field as an array and then pass it in.
          }
