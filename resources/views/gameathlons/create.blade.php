...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10 m-b-0">
      <div class="column">
        <h1 class="title is-admin is-4">New GameAthlon</h1>
      </div>
      <div class="column">
    ...
    <form action="{{route('gameathlons.store')}}" method="post">
      {{ csrf_field() }}
      <div class="columns">
        <div class="column is-three-quarters-desktop is-three-quarters-tablet">
          <b-field>
            <b-input type="text" placeholder="GameAthlon Title" size="is-large" v-model="title">
            </b-input>
          </b-field>
