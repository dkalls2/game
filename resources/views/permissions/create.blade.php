          ...
          <div class="columns" v-if="permissionType == 'crud'">
            <div class="column is-one-quarter">
              {{-- <b-checkbox-group v-model="crudSelected"> --}}
                <div class="field">
                  <b-checkbox name = "crudSelected" v-model="crudSelected" native-value="create">Create</b-checkbox>
                </div>
                <div class="field">
                  <b-checkbox name = "crudSelected" v-model="crudSelected" native-value="read">Read</b-checkbox>
                </div>
                <div class="field">
                  <b-checkbox name = "crudSelected" v-model="crudSelected" native-value="update">Update</b-checkbox>
                </div>
                <div class="field">
                  <b-checkbox name = "crudSelected" v-model="crudSelected" native-value="delete">Delete</b-checkbox>
                </div>
              {{-- </b-checkbox-group> --}}
            </div> <!-- end of .column -->
